...
var HotelService = (function () {
    ...
    HotelService.prototype.deleteRoom = function (id) {
        return this.http.delete('http://127.0.0.1:8000/pollsAPI/room/' + id).map(function (data) { return data.json(); });
    ...
    HotelService.prototype.deleteDispo = function (id) {
        return this.http.delete('http://127.0.0.1:8000/pollsAPI/roomD/' + id).map(function (data) { return data.json(); });
    ...
    HotelService.prototype.addReserv = function (start, end, id, us) {
    ...
    HotelService.prototype.afficherdispobyRT = function (id) {
    ...
    HotelService.prototype.afficherreservbyRT = function (id) {
